...
| 구분 |    내용   |  결과물 |
|------|-----------|---------|
| ***분석*** | <br>1. 주요활동</br> <br>데이터 분석 (시장조사 결과 데이터)</br><br>SWOT 분석</br><br>시장 세분화 및 타겟팅</br> | <br> 결과물 </br> <br>요구사항 명세서 (Requirements Specification): 기능적/비기능적 요구사항을 정리한 문서.</br><br>우선순위 목록 (Priority List): 요구사항의 우선순위에 따른 작업 우선순위 목록.</br>|
- **설명**
